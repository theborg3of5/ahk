...
; Program in general
#HotIf Config.isWindowActive("Outlook")
...
; Mail folders
#HotIf Config.isWindowActive("Outlook") && (Outlook.isCurrentScreenMail() || Outlook.isMailMessagePopupActive())
	...
	!w::ActionObjectEMC2(Outlook.getMessageTitle()).openWeb()
	!e::ActionObjectEMC2(Outlook.getMessageTitle()).openEdit()
#HotIf

; Normal calendar
#HotIf Outlook.isNormalCalendarActive()
...
; TLG calendar
#HotIf Outlook.isTLGCalendarActive()
...
; Calendar folders
#HotIf Config.isWindowActive("Outlook") && Outlook.isCurrentScreenCalendar()
