...
class MicrosoftLib {
	...
	; https://www.autohotkey.com/docs/commands/SysGet.htm#Numeric
	...
	;region System-level window measurements
	...
	;endregion System-level window measurements
	...
	;region Scroll Bar Requests/Messages
	; https://docs.microsoft.com/en-us/windows/desktop/Controls/about-scroll-bars
	...
	;endregion Scroll Bar Requests/Messages
	
	;region App Commands
	; For use with WM_APPCOMMAND: https://docs.microsoft.com/en-us/windows/win32/inputdev/wm-appcommand
	...
	;region Info options
	; For use with SystemParametersInfoA: https://docs.microsoft.com/en-us/windows/win32/api/winuser/nf-winuser-systemparametersinfoa
