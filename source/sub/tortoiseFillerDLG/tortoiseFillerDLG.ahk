...
CommonHotkeys.Init(CommonHotkeys.ScriptType_Sub, "DoFill")
...
SetTimer, DoFill, -100 ; Run once to start, timer toggled by CommonHotkeys' suspend hotkey.
