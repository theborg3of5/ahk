...
#HotIf Config.isWindowActive("VSCode AHK")
	...
	^+Enter:: HeaderDocBlock().rewrapSelection()
	^+!Enter::HeaderDocBlock().unwrapSelection()

	; AHK debug strings
	:X:dbpop::	VSCode.sendAHKDebugCodeString("Debug.popup",      A_Clipboard) ; Debug popup
	:X:dbto::	VSCode.sendAHKDebugCodeString("Debug.toast",      A_Clipboard) ; Debug toast
	:X:edbpop::	VSCode.sendAHKDebugCodeString("Debug.popupEarly", A_Clipboard) ; Debug popup that appears at startup
	:X:dbcon::	VSCode.sendAHKDebugCodeString("Debug.console",    A_Clipboard) ; Debug console
...
#HotIf Config.isWindowActive("VSCode EpicCode")
...
#HotIf Config.isWindowActive("VSCode")
