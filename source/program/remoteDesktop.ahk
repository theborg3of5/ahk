...
#HotIf Config.isWindowActive("Remote Desktop") || Config.isWindowActive("Remote Desktop Reconnecting")
...
#HotIf !Config.isWindowActive("Remote Desktop") && Config.doesWindowExist("Remote Desktop")
...
#HotIf !Config.doesWindowExist("Remote Desktop")
