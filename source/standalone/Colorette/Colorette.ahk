; http://www.autohotkey.com/forum/topic69559.html
; ******* General ******* 
; COLORETTE
ScriptVersion := 1.0
...
If (FileExist("colorette.exe"))
   Menu, Tray, Icon, Colorette.ico  ;*gdb 2/15 - Use extracted .ico instead of .exe
...
RestoreCursors()
msgbox, color
; Dlg_Color(color) ;*gdb 2/15 - Not really sure what this does, but commenting it out allows me to run from source, and doesn't seem to have any immediate adverse effects.
Gosub, ColorPicked
return
