...
class TableListMod2 {
	...
	executeMod(ByRef row) {
		...
		if(this.operation = TableListMod2.Operation_Replace)
			newValue := this.text
		else if(this.operation = TableListMod2.Operation_AddToStart)
			newValue := this.text columnValue
		else if(this.operation = TableListMod2.Operation_AddToEnd)
