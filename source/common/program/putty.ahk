class Putty {
	...
	;---------
	static wipeScreen(clearScrollback := false) {
	...
	;---------
	static recordEditSearch(usePrevious := false) {
		...
		if(searchType = "" || searchText = "") {
			data := Selector("puttyRecordEditSearch.tls").prompt()
